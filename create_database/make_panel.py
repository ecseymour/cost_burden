...
for k, v in code_dict.iteritems():
	...
	E.AX7AB1980 * 1.0 / (E.AX7AB1980 + E.AX7AA1980) * 100 AS povrate,
	F.C8J001 AS medval,
...
for k, v in code_dict.iteritems():
	...
	E.AX7AB1990 * 1.0 / (E.AX7AB1990 + E.AX7AA1990) * 100 AS povrate,
	A.EST001 AS medval,
...
for k, v in code_dict.iteritems():
	...
	E.AX7AB2000 * 1.0 / (E.AX7AB2000 + E.AX7AA2000) * 100 AS povrate,
	A.GB7001 AS medval,
